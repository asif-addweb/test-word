...
if ( ! class_exists( 'WP_List_Table' ) ) {
    ...
    class Customers_List extends WP_List_Table {
        ...
        'plural' => __( 'user', 'sp' ), //plural name of the listed records
...
* @return mixed
*/
public static function get_user( $per_page = 5, $page_number = 1 ) {

    global $wpdb;
    
    $sql = "SELECT * FROM {$wpdb->prefix}user";
...
public static function record_count() {
    ...
    $sql = "SELECT COUNT(*) FROM {$wpdb->prefix}user";
